...
class U(Module):
    ...
    def forward(self, state: torch.Tensor, thetas: torch.Tensor) -> torch.Tensor:
        """
        Represents batched state and theta forwarding  to the matrices and apply functions that are part of the U gate implementation

        Arguments:
            state  (torch.Tensor): batched state
            thetas (torch.Tensor): Tensor of size (3, batch_size) which contains the values of `phi`/`theta`/`omega`
...
class RX(RotationGate):
    def __init__(self, qubits: ArrayLike, n_qubits: int):
        ...
        The RX gate class creates a single-qubit RX gate that performs a given rotation around the X axis.

        Arguments:
            qubits (ArrayLike): The qubits to apply the RX gate to. It should be a list of qubit indices.
            n_qubits (int): The total number of qubits in the circuit.
...
class RY(RotationGate):
    def __init__(self, qubits: ArrayLike, n_qubits: int):
        ...
        The RY gate class creates a single-qubit RY gate that performs a given rotation around the Y axis.
...
class RZ(RotationGate):
    def __init__(self, qubits: ArrayLike, n_qubits: int):
        ...
        The RZ gate class creates a single-qubit RZ gate that performs a given rotation around the Z axis.
...
class CRX(ControlledRotationGate):
    def __init__(self, qubits: ArrayLike, n_qubits: int):
        ...
        The CRX gate class creates a controlled RX gate, applying the RX according to the control qubit state.


        Arguments:
            qubits (ArrayLike): The qubit index or list of qubit indices where the controlled CRX gate acts on.
            n_qubits (int): The total number of qubits in the circuit.
...
class CRY(ControlledRotationGate):
    def __init__(self, qubits: ArrayLike, n_qubits: int):
        ...
        The CRY gate class creates a controlled RY gate, applying the RY according to the control qubit state.


        Arguments:
            qubits (ArrayLike): The qubit index or list of qubit indices where the controlled CRY gate acts on.
            n_qubits (int): The total number of qubits in the circuit.
...
class CRZ(ControlledRotationGate):
    def __init__(self, qubits: ArrayLike, n_qubits: int):
        ...
        The CRZ gate class creates a controlled RZ gate, applying the RZ according to the control qubit state.

        Arguments:
            qubits (ArrayLike): The qubit index or list of qubit indices where the controlled CRZ gate acts on.
            n_qubits (int): The total number of qubits in the circuit.
...
class CPHASE(Module):
    ...
    def __init__(self, qubits: ArrayLike, n_qubits: int):
        ...
        The CPhase gate class creates a controlled Phase gate, applying the PhaseGate according to the control qubit state.

        Arguments:
            qubits (ArrayLike): The control and target qubits for the CPHASE gate. It should be a list of two qubits.
            n_qubits (int): The total number of qubits in the circuit.
