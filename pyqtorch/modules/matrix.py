...
class CustomMatrix(Tensor):
    ...
    def __matmul__(self, other: object):
        R11 = torch.matmul(self.real[0,:], other.real[:,0]) - torch.matmul(self.imag[0,:], other.imag[:,0])
        R12 = torch.matmul(self.real[0,:], other.real[:,1]) - torch.matmul(self.imag[0,:], other.imag[:,1])
        R21 = torch.matmul(self.real[1,:], other.real[:,0]) - torch.matmul(self.imag[1,:], other.imag[:,0]) 
        R22 = torch.matmul(self.real[1,:], other.real[:,1]) - torch.matmul(self.imag[1,:], other.imag[:,1])
        I11 = torch.matmul(self.real[0,:], other.imag[:,0]) + torch.matmul(self.imag[0,:], other.real[:,0])
        I12 = torch.matmul(self.real[0,:], other.imag[:,1]) + torch.matmul(self.imag[0,:], other.real[:,1])
        I21 = torch.matmul(self.real[1,:], other.imag[:,0]) + torch.matmul(self.imag[1,:], other.real[:,0])
        I22 = torch.matmul(self.real[1,:], other.imag[:,1]) + torch.matmul(self.imag[1,:], other.real[:,1])
